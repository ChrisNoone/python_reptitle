...
hds = [{'User-Agent': 'Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.1.6) Gecko/20091201 Firefox/3.5.6'}, \
       {'User-Agent': 'Mozilla/5.0 (Windows NT 6.2) AppleWebKit/535.11 (KHTML, like Gecko) Chrome/17.0.963.12 Safari\ '
                      '/535.11'}, {'User-Agent': 'Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)'}]
...
def book_spider(book_tag):
    ...
    while (1):
        ...
        try:
            ...
            source_code = request.urlopen(req).read().decode()
        ...
        if list_soup == None and try_times < 10:
            continue
        elif list_soup == None or len(list_soup) <= 1 or page_num > 1:
